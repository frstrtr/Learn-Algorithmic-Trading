...
ETHBTC_data=load_financial_data(start_date='2001-01-01',
                    end_date = '2018-01-01',
...
X,Y=create_trading_condition(ETHBTC_data)
...
ETHBTC_data['Predicted_Signal']=svc.predict(X)
...
cum_ETHBTC_return=calculate_return(ETHBTC_data,split_value=len(X_train),symbol='ETHBTC')
cum_strategy_return= calculate_strategy_return(ETHBTC_data,split_value=len(X_train))
